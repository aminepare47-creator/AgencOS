...
export const WhyUsSection: React.FC = () => {
  ...
  return (
    <section id="why-us-section" className="py-20 bg-[#faf8ff] text-[#131b2e] border-t border-[#e2e7ff]">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="font-display font-bold text-3xl sm:text-4xl text-[#003629] tracking-tight mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          {/* Card 1 */}
          <div className="bg-white border border-[#e2e7ff] rounded-2xl p-7 flex flex-col justify-between hover:border-[#1b4d3e] transition-colors shadow-xs">
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#eaedff] text-[#003629] flex items-center justify-center font-bold mb-5">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <h3 className="font-display font-bold text-lg text-[#003629] mb-2">
            ...
            <div className="pt-6 border-t border-[#e2e7ff] mt-6 text-xs text-[#1b4d3e] font-bold flex items-center gap-2 font-mono">
          ...
          <div className="bg-white border border-[#e2e7ff] rounded-2xl p-7 flex flex-col justify-between hover:border-[#1b4d3e] transition-colors shadow-xs">
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#baeed9] text-[#002117] flex items-center justify-center font-bold mb-5">
        ...
        <div className="bg-[#003629] text-white rounded-2xl p-8 sm:p-10 shadow-md">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            <div className="lg:col-span-8 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-[#baeed9] text-xs font-mono font-bold uppercase tracking-wider border border-white/10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs">
                <div className="bg-white/10 border border-white/15 p-3.5 rounded-xl">
                  <span className="font-bold text-[#baeed9] block mb-1 font-mono text-[11px] uppercase">
                    Phase 1 (Actuelle)
                  </span>
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
              <button
                ...
                className="w-full py-3.5 px-5 rounded-lg bg-[#baeed9] hover:bg-[#9ed1bd] text-[#002117] font-bold text-xs sm:text-sm shadow-sm transition-colors flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              >
                ...
                <ArrowRight className="w-4 h-4 text-[#baeed9]" />
              </button>
            </div>
