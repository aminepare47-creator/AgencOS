...
export const SupportPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-[#131b2e] pt-28 pb-20 font-sans">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          <button
            ...
            className="inline-flex items-center gap-2 text-xs font-bold text-[#003629] hover:underline cursor-pointer"
          >
        ...
        {/* Hero Support */}
        <div className="bg-white rounded-2xl border border-[#e2e7ff] p-8 sm:p-10 mb-8 shadow-xs">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#eaedff] text-[#003629] text-xs font-mono font-bold uppercase tracking-wider mb-4 border border-[#c0c9c3]/50">
            <LifeBuoy className="w-3.5 h-3.5 text-[#1b4d3e]" />
          ...
          <div className="mt-6 p-5 rounded-xl bg-[#003629] text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#baeed9] font-bold block">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-4 py-2.5 rounded-lg bg-[#baeed9] hover:bg-[#a6e6cb] text-[#002117] font-bold text-xs flex items-center gap-2 transition-colors cursor-pointer"
              >
                <MessageSquare className="w-4 h-4 text-[#003629]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          ...
          <div className="bg-white rounded-2xl border border-[#e2e7ff] p-6 shadow-xs">
            <div className="w-10 h-10 rounded-lg bg-[#f2f3ff] text-[#003629] flex items-center justify-center mb-4">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e7ff] p-8 sm:p-10 shadow-xs">
          ...
          {ticketSubmitted ? (
            <div className="py-8 text-center max-w-lg mx-auto space-y-4">
              ...
              <h2 className="font-display font-bold text-2xl text-[#003629]">
                Demande d'intervention reçue !
              </h2>
              <p className="text-xs sm:text-sm text-[#545f73] leading-relaxed">
                Notre équipe technique a bien reçu votre signalement concernant <strong className="text-[#131b2e]">{form.sujet || 'votre requête'}</strong>. Un ingénieur prendra attache avec vous sur le numéro <strong className="text-[#003629]">{form.telephone}</strong>.
              </p>
              <div className="pt-4">
                <button
                  onClick={() => {
                  ...
                  className="px-6 py-2.5 rounded-lg bg-[#1b4d3e] hover:bg-[#003629] text-white font-bold text-xs cursor-pointer shadow-sm transition-colors"
                >
            ...
            <form onSubmit={handleTicketSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-lg border border-[#c0c9c3] bg-[#faf8ff] text-xs text-[#131b2e] focus:outline-none focus:border-[#1b4d3e] focus:bg-white font-mono"
                  />
                </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[#e2e7ff]">
                <span className="text-xs text-[#545f73]">
                  Numéro direct d'astreinte : <strong className="text-[#003629] font-mono">+226 55 30 08 68</strong>
                </span>
                <button
                  type="submit"
                  className="w-full sm:w-auto px-6 py-3 rounded-lg bg-[#1b4d3e] hover:bg-[#003629] text-white font-bold text-xs flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-sm"
                >
