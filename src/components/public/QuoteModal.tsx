...
export const QuoteModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs overflow-y-auto font-sans">
      <div className="relative w-full max-w-2xl bg-white text-[#131b2e] rounded-2xl shadow-xl border border-[#e2e7ff] overflow-hidden my-8">
        ...
        <div className="p-6 sm:p-8">
          {submitted ? (
            <div className="py-8 text-center space-y-4">
              ...
              <h4 className="text-xl font-display font-bold text-[#003629]">
                Demande de devis enregistrée !
              </h4>
              <p className="text-xs sm:text-sm text-[#545f73] max-w-md mx-auto leading-relaxed">
                Votre projet pour <strong className="text-[#131b2e]">{form.entreprise || form.clientNom}</strong> a été indexé sous la référence <code className="bg-[#eaedff] px-2 py-0.5 rounded font-mono text-[#003629] font-bold border border-[#c0c9c3]/50">{newQuoteId}</code>. Notre direction technique analyse votre cahier des charges et prendra contact avec vous.
              </p>
              <div className="pt-4">
                <button
                  onClick={handleClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                  <button
                    ...
                    className={`p-3 rounded-xl border text-left transition-all cursor-pointer ${
                      form.typeOffre === 'digitalisation_az'
                        ? 'border-2 border-[#1b4d3e] bg-[#f2f3ff] text-[#003629]'
                        : 'border-[#c0c9c3] bg-white hover:bg-[#faf8ff] text-[#545f73]'
                    }`}
                  >
                    <p className="text-xs font-display font-bold text-[#003629]">Offre A : A à Z</p>
                  ...
                  >
                    <p className="text-xs font-display font-bold text-[#003629]">Offre B : Boost</p>
                  ...
                  >
                    <p className="text-xs font-display font-bold text-[#003629]">Sur Mesure</p>
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-2 rounded-lg text-xs font-medium border flex items-center justify-between transition-colors text-left cursor-pointer ${
                          selected
                            ? 'bg-[#baeed9]/50 text-[#002117] border-[#1b4d3e] font-bold'
                            : 'bg-[#faf8ff] text-[#131b2e] border-[#c0c9c3] hover:bg-white'
                        }`}
                      >
                        <span className="truncate">{service}</span>
                        {selected && <Check className="w-3.5 h-3.5 text-[#003629] shrink-0 ml-1.5" />}
                      </button>
                    );
                  })}
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg border border-[#c0c9c3] text-xs text-[#131b2e] bg-[#faf8ff] focus:outline-none focus:border-[#1b4d3e] focus:bg-white font-mono"
                >
              ...
              {/* Vos coordonnées */}
              <div className="space-y-3 pt-2 border-t border-[#e2e7ff]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div>
                    <select
                      ...
                      className="w-full px-3.5 py-2 rounded-lg border border-[#c0c9c3] bg-[#faf8ff] text-xs text-[#131b2e] focus:outline-none focus:border-[#1b4d3e] focus:bg-white"
                    >
              ...
              {/* Submit CTA */}
              <div className="pt-3 flex items-center justify-between border-t border-[#e2e7ff]">
                <button
                  type="button"
                  onClick={handleClose}
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-lg bg-[#1b4d3e] hover:bg-[#003629] text-white font-bold text-xs flex items-center gap-2 shadow-sm transition-colors cursor-pointer"
                >
