    ...
    <div className="min-h-screen bg-[#faf8ff] text-[#131b2e] pt-28 pb-20 font-sans">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e7ff] p-8 sm:p-10 mb-8 shadow-xs">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-6 pt-6 border-t border-[#e2e7ff] text-xs text-[#545f73] font-mono">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e7ff] p-8 sm:p-10 shadow-xs space-y-10 text-xs sm:text-sm text-[#404945] leading-relaxed">
          
          {/* Section 1 */}
          <section className="space-y-3">
            <div className="flex items-center gap-2.5 text-base font-bold text-[#003629] font-display">
          ...
          {/* Section 2 */}
          <section className="space-y-3 pt-6 border-t border-[#e2e7ff]">
            <div className="flex items-center gap-2.5 text-base font-bold text-[#003629] font-display">
          ...
          <section className="space-y-3 pt-6 border-t border-[#e2e7ff]">
            <div className="flex items-center gap-2.5 text-base font-bold text-[#003629] font-display">
              <Server className="w-5 h-5 text-[#1b4d3e]" />
          ...
          <section className="space-y-3 pt-6 border-t border-[#e2e7ff]">
            ...
            <div className="p-4 rounded-xl bg-[#faf8ff] border border-[#e2e7ff] space-y-1.5 text-xs font-mono">
          ...
          <section className="p-4 rounded-xl bg-[#eaedff] border border-[#1b4d3e]/20 text-xs text-[#003629]">
