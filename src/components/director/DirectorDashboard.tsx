...
export const DirectorDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-[#131b2e] flex flex-col font-sans">
      ...
      <header className="bg-white text-[#131b2e] border-b border-[#e2e7ff] sticky top-0 z-40 shadow-xs">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="p-2 rounded-lg bg-[#faf8ff] hover:bg-[#eaedff] text-[#003629] border border-[#c0c9c3] transition-colors flex items-center gap-1.5 text-xs font-bold cursor-pointer"
              ...
              <div className="h-6 w-px bg-[#e2e7ff] hidden sm:block" />

              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-[#003629] flex items-center justify-center font-bold text-white text-xs font-display">
                  AOS
                </div>
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="font-extrabold text-sm tracking-tight text-[#003629] font-display">
                      AgenceOS
                    </span>
                    <span className="text-[10px] font-mono font-bold bg-[#baeed9] text-[#002117] border border-emerald-300 px-2 py-0.2 rounded-full flex items-center gap-1">
            ...
            <div className="flex items-center gap-3">
              {pendingTestsCount > 0 && (
                <button
                  ...
                  className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#eaedff] border border-[#1b4d3e] text-[#003629] text-xs font-bold font-mono cursor-pointer"
                >
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-white hover:bg-[#faf8ff] text-[#545f73] hover:text-[#003629] border border-[#c0c9c3] text-xs font-semibold transition-colors flex items-center gap-1 cursor-pointer"
              >
          ...
          {/* Navigation Tabs Bar */}
          <div className="flex items-center gap-1.5 overflow-x-auto py-2.5 border-t border-[#e2e7ff] no-scrollbar">
            {tabs.map(tab => {
                ...
                <button
                  ...
                  className={`px-3.5 py-2 rounded-lg text-xs font-bold whitespace-nowrap flex items-center gap-2 transition-all cursor-pointer ${
                    isActive
                      ...
                      : 'text-[#545f73] hover:text-[#003629] hover:bg-[#f2f3ff]'
                  }`}
                >
                  {tab.icon}
                  <span>{tab.label}</span>
                  {tab.badge !== undefined && (
                    <span className={`px-1.5 py-0.2 rounded-full text-[10px] font-extrabold font-mono ${
                      isActive ? 'bg-[#baeed9] text-[#002117]' : 'bg-[#1b4d3e] text-white'
                    }`}>
                      {tab.badge}
                    </span>
                  )}
