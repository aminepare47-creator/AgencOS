      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {testTemplates.map(test => {
          ...
          return (
            <div
              key={test.id}
              className="bg-white rounded-2xl border border-[#e2e7ff] p-6 shadow-xs hover:border-[#1b4d3e] transition-all flex flex-col justify-between"
            >
              <div>
                {/* Meta Header */}
                <div className="flex items-center justify-between gap-2 mb-3">
                  <span className="text-xs font-bold text-[#003629] bg-[#eaedff] border border-[#1b4d3e]/20 px-3 py-0.5 rounded-full font-mono">
                ...
                <div className="mb-4">
                  ...
                  <div className="bg-[#faf8ff] p-3.5 rounded-xl border border-[#e2e7ff] text-xs text-[#545f73] line-clamp-3 leading-relaxed whitespace-pre-line">
                    {test.consignes}
                  </div>
                </div>
              ...
              {/* Action Buttons */}
              <div className="pt-4 border-t border-[#e2e7ff] flex items-center justify-between text-xs">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-[#faf8ff] hover:bg-[#eaedff] text-[#003629] border border-[#c0c9c3] font-bold flex items-center gap-1.5 transition-colors cursor-pointer text-xs"
                    title="Simuler le parcours côté candidat"
                  >
                    <Eye className="w-3.5 h-3.5 text-[#003629]" />
                    <span>Aperçu candidat</span>
                  </button>

                  <button
                    onClick={() => handleEdit(test)}
                    className="px-3 py-1.5 rounded-lg bg-[#1b4d3e] hover:bg-[#003629] text-white font-bold flex items-center gap-1.5 transition-colors cursor-pointer text-xs shadow-xs"
                  >
