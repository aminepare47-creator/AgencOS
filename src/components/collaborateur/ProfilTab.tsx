...
export const MemberCard: React.FC = () => {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-[#003629] to-[#1b4d3e] text-white p-6 shadow-lg relative overflow-hidden">
      <div className="absolute -right-14 -top-14 w-52 h-52 rounded-full bg-[#baeed9]/10 blur-2xl pointer-events-none" />
      <div className="flex items-start justify-between gap-4 relative z-10">
        <div>
          <p className="text-[10px] font-mono uppercase tracking-widest text-[#baeed9] mb-2">
          ...
          <p className="mt-4 text-xs font-mono font-bold tracking-wider text-[#baeed9]">
        ...
        <div className="shrink-0 bg-white p-2 rounded-lg shadow-sm">
          {currentCollaborateur.qrCodeData ? (
            ...
            <div className="w-24 h-24 flex items-center justify-center text-[#003629] text-xs">QR</div>
          )}
        </div>
      </div>
      <div className="mt-4 relative z-10 inline-flex items-center gap-1.5 text-[10px] text-white/60 bg-white/10 border border-white/15 rounded-full px-3 py-1">
        <BadgeCheck className="w-3.5 h-3.5 text-[#baeed9]" />
...
export const ProfilTab: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <MemberCard />
      <div className="rounded-xl bg-white border border-[#e2e7ff] p-6">
        <h3 className="font-display font-bold text-base text-[#003629] mb-4">Informations personnelles</h3>
        <ul className="space-y-3 text-sm">
          ...
          <li className="flex items-center gap-3 text-[#545f73]">
            <Mail className="w-4 h-4 text-[#1b4d3e]" /> {currentCollaborateur.email}
          </li>
          <li className="flex items-center gap-3 text-[#545f73]">
            <Phone className="w-4 h-4 text-[#1b4d3e]" /> {currentCollaborateur.telephone}
          </li>
          <li className="flex items-center gap-3 text-[#545f73]">
            <MapPin className="w-4 h-4 text-[#1b4d3e]" /> {currentCollaborateur.ville}
          </li>
          <li className="flex items-center gap-3 text-[#545f73]">
        ...
        <p className="mt-5 text-[11px] text-[#545f73] border-t border-[#e2e7ff] pt-4">
          Numéro de membre : <span className="font-mono font-bold text-[#1b4d3e]">{currentCollaborateur.numeroMembre}</span>
          <br />
